		...
		public void keyPressed(KeyEvent e){
			...
			if(key_==38){
				...
				if (ram==1) {
					...
					gameP.head.setText("Âûáîð óðîâíÿ");
					gameP.mes.setText("Ââåäèòå íàçâàíèå óðîâíÿ:");
					...
					gameP.head.setVisible(true);
					gameP.textField.setVisible(true);
					gameP.head.setText("Ðåäàêòîð êàðò");
					gameP.mes.setText("Ââåäèòå íàçâàíèå êàðòû:");
					gameP.textField.setText("");
					gameP.textField.requestFocus();
	...
	public menu(){
		...
		keylis1=new KeyAdapter() {
		     ...
		     public void keyPressed(KeyEvent e) {
		        ...
		        if (key == 10) {		// íàæàòà êëàâèøà - Enter
					...
					if(name.length()==0){
					 ...
					 map = new File("./Pasan_UserMaps/"+name+".pasan");
				        ...
				        if(map.exists()){
							...
							gameP.head.setVisible(true);
							gameP.textField.setVisible(false);
							gameP.head.setText("Îøèáêà");
							gameP.mes.setText("Óðîâåíü ñ òàêèì èìåíåì íå íàéäåí");
							requestFocus();
							gameP.textField.removeKeyListener(keylis1);
				        }
					...
					if(name.length()==0){
					 ...
					 try{
				        if(!map.exists()){
							...
							gameP.head.setText("Ðåäàêòîð êàðò");
							gameP.mes.setText("<html>Êàðòà ñ òàêèì èìåíåì óæå ñóùåñòâóåò.<br>Îòêðûòü å¸ äëÿ ðåäàêòèðîâàíèÿ?</html>");
							requestFocus();
							gameP.textField.removeKeyListener(keylis2);
				        }
					 }
