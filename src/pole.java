...
public class pole extends JPanel{
	...
	boolean stop=false;
	boolean ram=true;
	int animation=0;//Кол-во анимаций
	int anima=1; //Анимация в данный момент
	int[][] anim = new int[100][5];//0 - движение, 1 - стрела, 2 - фаербол, 3 - ледяные объятья, 4 - высокое напряжение; 1 - начальная точка, 2 - конечная точка
	...
	public void paintComponent(Graphics gr){
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		if(animation>0){
			if(anim[anima][0]==0){ // Движение
				if(anim[anima][1]==0){//Влево
			...
			if(anim[anima][1]>anim[anima][2]){//Влево или вверх
				if(anim[anima][1]-anim[anima][2]>=15){//Вверх
			...
			else if(anim[anima][2]>anim[anima][1]){//Вправо или вниз
				if(anim[anima][2]-anim[anima][1]>=15){//Вниз
					if((magic<10)|(Integer.parseInt(lol[anim[anima][1]-anim[anima][1]/15*15][anim[anima][1]/15])!=0)){
			...
			if(arrowpos>=10){
				...
				else if(anim[anima][0]==7){ // Смертельный удар
				...
				else if(anim[anima][0]==8){ // Тычка мечом
					if(anim[anima][1]>anim[anima][2]){//Влево или вверх
						if(anim[anima][1]-anim[anima][2]>=15){//Вверх
							if((magic<10)|(Integer.parseInt(lol[anim[anima][1]-anim[anima][1]/15*15][anim[anima][1]/15])!=0)){
				...
				else if(anim[anima][0]==9){ // Тычка дуалами
					if(anim[anima][1]>anim[anima][2]){//Влево или вверх
						if(anim[anima][1]-anim[anima][2]>=15){//Вверх
							if((magic<10)|(Integer.parseInt(lol[anim[anima][1]-anim[anima][1]/15*15][anim[anima][1]/15])!=0)){
